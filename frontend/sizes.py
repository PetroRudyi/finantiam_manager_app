...
# ── Шрифти (Font sizes) ──────────────────────────────
FONT_XS     = 8    # Найменший: заголовки колонок таблиці, мітки графіків
FONT_SM     = 9    # Малий: секційні заголовки, моно-мітки, підписи
...
FONT_LG     = 13   # Великий текст: назви у списках, значення полів
FONT_NAV    = 14   # Навігаційні елементи: стрілки, назва місяця
FONT_TITLE  = 15   # Заголовки екранів та діалогів
